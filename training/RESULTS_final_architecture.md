...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| ours O+D OOF | 2238 | 1.063 | 0.809 | +0.851 | +0.923 | +0.911 | 4.05 | +0.436 | 81/100 |
...
Season-cluster bootstrap, RMSE(ours) − RMSE(Paine): **-0.236** (95% CI -0.282 to -0.186).
...
| system | n | RMSE | MAE | R² | Pearson | Spearman | dev@10 | tau@10 | hits@10 |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| ours matched OOF | 2238 | 0.811 | 0.629 | +0.797 | +0.895 | +0.886 | 6.09 | +0.498 | 71/100 |
...
Season-cluster bootstrap, RMSE(ours) − RMSE(Paine): **-0.327** (95% CI -0.372 to -0.283).
...
- Defense adds 12 cell-relative and 8 nearest-defender features.
...
- End-to-end benchmark wall time: 127.2 seconds on the machine that generated this report.
