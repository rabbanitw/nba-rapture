...
def main():
    ...
    (TD / "RESULTS_loso_rapm_hat_rep2.json").write_text(
        json.dumps(per_season, indent=1))
    print("wrote RESULTS_loso_rapm_hat_rep2.json", flush=True)
